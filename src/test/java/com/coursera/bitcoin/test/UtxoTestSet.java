package com.coursera.bitcoin.test;// Copyright (C) 2016-2017 Enrique Albertos
// Distributed under the GNU GPL v2 software license

import com.coursera.bitcoin.Transaction;
import com.coursera.bitcoin.UTXO;
import com.coursera.bitcoin.UTXOPool;
